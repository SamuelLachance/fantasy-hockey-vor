...
const files: Record<string, string[]> = {
  ...
  "src/components/RankingsTableInner.tsx": [
    ...
    "useOrphanedBoardRowFocusRestore",
    ...
    "linked.urlPlayerId",
    "linked.titlePlayerName",
    "linked.chipPlayerName",
    "linked.emptyPlayerName",
    "revealPendingPlayer",
  ...
  "src/hooks/useOrphanedBoardRowFocusRestore.ts": [
    "useOrphanedBoardRowFocusRestore",
  ...
  // Cross-page navigation (board header + footer → /league, /snake).
  ...
  "src/lib/site-nav.ts": ['"/league"', '"/snake"', "(FR)", "fr-CA", "Other tools"],
  ...
  "src/app/snake/loading.tsx": ['lang="fr-CA"', 'role="status"', "motion-reduce:animate-none"],
  ...
  "src/components/snake/SnakeMethodology.tsx": [
    'id="sources"',
  ...
  "src/components/snake/SnakeBoardChip.tsx": ['lang="fr-CA"', "sr-only", 'aria-hidden="true"', "snakeChipTitle", "outline-dashed"],
  "src/components/snake/SnakeBoardLegend.tsx": ["useSnakeBoardStatus", "SnakeDisclaimerShort", 'status !== "ready"'],
  "src/components/snake/SnakeRankings.tsx": ["armed", "loadSnakeRankings", "IntersectionObserver", "rankingHeadingId"],
  "src/components/snake/SnakeLeague.tsx": ["SnakeLeagueProvider", "scheduleIdle", "loadSnakeFantrax", "snakePlayerHref", "prefetch={false}"],
  "src/lib/snake/board-store.ts": ["useSyncExternalStore", "scheduleIdle", "prefersSaveData", "serverRows"],
  "src/components/league/LeagueDaily.tsx": ["SnakeLeagueProvider", "SnakeDisclaimerShort", "snakeSeed"],
  "src/components/league/WeekGrid.tsx": ["SnakeLeagueMini id={r.id} decorative"],
};
