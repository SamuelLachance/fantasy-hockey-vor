  ...
  return (
    <header className="relative border-b border-white/10 bg-slate-950/80 pt-[env(safe-area-inset-top,0px)] backdrop-blur-xl motion-reduce:backdrop-blur-none">
      ...
      <a
        ...
        className="sr-only focus:not-sr-only focus:absolute focus:left-[calc(env(safe-area-inset-left,0px)+1rem)] focus:top-[calc(var(--board-safe-area-inset-top,0px)+1rem)] focus:z-50 focus:inline-flex focus:min-h-11 focus:items-center focus:rounded-lg focus:bg-cyan-500 focus:px-3 focus:py-2 focus:text-sm focus:font-semibold focus:text-slate-950"
      >
        {skipToRankingsCopy()}
      </a>
