        ...
        <div className="flex shrink-0 items-center gap-1">
          {activeFilterCount > 0 && (
            <button
              ...
              className="inline-flex min-h-11 items-center gap-1 rounded-lg px-2 py-1 text-xs text-slate-400 transition hover:bg-white/5 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300/80"
            >
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {filterRangeKeys.map((key) => {
          ...
          const inputClass = inverted
            ? "min-h-11 w-full rounded-lg border border-rose-500/50 bg-slate-950/60 px-2 py-1.5 text-base tabular-nums text-white placeholder:text-slate-600 focus:border-rose-400/60 focus:outline-none focus:ring-2 focus:ring-rose-500/30"
            : "min-h-11 w-full rounded-lg border border-white/10 bg-slate-950/60 px-2 py-1.5 text-base tabular-nums text-white placeholder:text-slate-600 focus:border-cyan-500/40 focus:outline-none focus:ring-2 focus:ring-cyan-500/25";
          return (
            <div
              key={key}
